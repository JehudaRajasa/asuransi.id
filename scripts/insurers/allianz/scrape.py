...
RAW_DIR = PROJECT_ROOT / "data" / "raw" / "insurers" / "allianz"

LANDINGS = [
    {
        "url": "https://www.allianz.co.id/produk/asuransi-individu/asuransi-kesehatan.html",
        "product_path_prefix": "/produk/asuransi-individu/asuransi-kesehatan/",
        "insurer_slug": "allianz-life",
        "insurer_name": "PT Asuransi Allianz Life Indonesia",
        "insurer_category": "asuransi_jiwa",
        "jenis": "konvensional",
    },
    {
        "url": "https://www.allianz.co.id/produk/asuransi-syariah/asuransi-kesehatan-syariah.html",
        "product_path_prefix": "/produk/asuransi-syariah/asuransi-kesehatan-syariah/",
        "insurer_slug": "allianz-life-syariah",
        "insurer_name": "PT Asuransi Allianz Life Syariah Indonesia",
        "insurer_category": "asuransi_jiwa",
        "jenis": "syariah",
    },
]
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Scrape Allianz health insurance product pages and PDFs (conv + syariah).")
