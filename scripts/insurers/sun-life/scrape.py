...
RAW_DIR = PROJECT_ROOT / "data" / "raw" / "insurers" / "sun-life"

LANDINGS = [
    {
        "url": "https://www.sunlife.co.id/id/insurance/health-insurance/",
        "product_path_prefix": "/id/insurance/health-insurance/",
        "insurer_slug": "sun-life",
        "insurer_name": "PT Sun Life Financial Indonesia",
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Scrape Sun Life Indonesia health insurance product pages and PDFs.")
