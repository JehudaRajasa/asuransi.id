...
RAW_DIR = PROJECT_ROOT / "data" / "raw" / "insurers" / "zurich-topas"

LANDINGS = [
    {
        "url": "https://www.zurich.co.id/produk-asuransi/untuk-kesehatan/",
        "product_path_prefix": "/produk-asuransi/untuk-kesehatan/",
        "insurer_slug": "zurich-topas",
        "insurer_name": "PT Zurich Topas Life",
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Scrape Zurich Topas Life health insurance product pages and PDFs.")
