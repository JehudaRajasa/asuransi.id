...
RAW_DIR = PROJECT_ROOT / "data" / "raw" / "insurers" / "generali"

LANDINGS = [
    {
        "url": "https://www.generali.co.id/id/produk/kesehatan/",
        "product_path_prefix": "/id/produk/kesehatan/",
        "insurer_slug": "generali",
        "insurer_name": "PT Asuransi Jiwa Generali Indonesia",
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Scrape Generali Indonesia health insurance product pages and PDFs.")
