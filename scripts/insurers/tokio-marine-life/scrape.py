...
RAW_DIR = PROJECT_ROOT / "data" / "raw" / "insurers" / "tokio-marine-life"

LANDINGS = [
    {
        "url": "https://www.tokiomarine-life.co.id/id/id/life/products/personal/health-protection/",
        "product_path_prefix": "/id/id/life/products/personal/health-protection/",
        "insurer_slug": "tokio-marine-life",
        "insurer_name": "PT Tokio Marine Life Insurance Indonesia",
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Scrape Tokio Marine Life Indonesia health insurance product pages and PDFs.")
