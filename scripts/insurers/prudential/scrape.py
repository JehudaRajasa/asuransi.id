...
RAW_DIR = PROJECT_ROOT / "data" / "raw" / "insurers" / "prudential"

EXCLUDE_PATH_SUFFIXES = ("/selengkapnya/", "/lihat-selengkapnya/")

LANDINGS = [
    {
        "url": "https://www.prudential.co.id/id/products/asuransi-kesehatan/",
        "product_path_prefix": "/id/products/asuransi-kesehatan/",
        "insurer_slug": "prudential-life-assurance",
        "insurer_name": "PT Prudential Life Assurance",
        "insurer_category": "asuransi_jiwa",
        "jenis": "konvensional",
    },
    {
        "url": "https://www.prudentialsyariah.co.id/id/products/asuransi-kesehatan/",
        "product_path_prefix": "/id/products/asuransi-kesehatan/",
        "insurer_slug": "prudential-sharia-life-assurance",
        "insurer_name": "PT. Prudential Sharia Life Assurance",
        "insurer_category": "asuransi_jiwa",
        "jenis": "syariah",
    },
]
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Scrape Prudential health insurance product pages and PDFs (conv + syariah).")
    ...
    for cfg in LANDINGS:
        ...
        products = discover_product_urls(landing_html, cfg["url"], cfg["product_path_prefix"], EXCLUDE_PATH_SUFFIXES)
