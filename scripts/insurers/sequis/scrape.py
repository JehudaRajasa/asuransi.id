...
RAW_DIR = PROJECT_ROOT / "data" / "raw" / "insurers" / "sequis"

LANDINGS = [
    {
        "url": "https://www.sequis.co.id/id/asuransi-kesehatan/individu/asuransi-kesehatan",
        "product_path_prefix": "/id/asuransi-kesehatan/individu/asuransi-kesehatan/",
        "insurer_slug": "sequis",
        "insurer_name": "PT Asuransi Jiwa Sequis Life",
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Scrape Sequis Life health insurance product pages and PDFs.")
