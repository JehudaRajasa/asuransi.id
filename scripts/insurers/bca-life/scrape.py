...
RAW_DIR = PROJECT_ROOT / "data" / "raw" / "insurers" / "bca-life"

LANDINGS = [
    {
        "url": "https://www.bcalife.co.id/produk/proteksi-individu/asuransi-kesehatan/",
        "product_path_prefix": "/produk/proteksi-individu/asuransi-kesehatan/",
        "insurer_slug": "bca-life",
        "insurer_name": "PT Asuransi Jiwa BCA",
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Scrape BCA Life health insurance product pages and PDFs.")
