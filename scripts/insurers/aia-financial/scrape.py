...
RAW_DIR = PROJECT_ROOT / "data" / "raw" / "insurers" / "aia-financial"

LANDINGS = [
    {
        "url": "https://www.aia-financial.co.id/id/our-products/kesehatan",
        "product_path_prefix": "/id/our-products/kesehatan/",
        "insurer_slug": "aia-financial",
        "insurer_name": "PT AIA Financial",
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Scrape AIA Financial health insurance product pages and PDFs.")
